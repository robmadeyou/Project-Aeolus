...
public class ItemDefinition {
	 ...
	 */
	private static ItemDefinition[] definitions = new ItemDefinition[20073];
	...
	public static ItemDefinition[] setDefinitions(final ItemDefinition[] read) {
		return definitions = read;
	}
