...
public class MeleeMaxHit {
	...
	public static double calculateBaseDamage(Player c, boolean special) {
		...
		if (c.playerEquipment[c.playerWeapon] == 4718
			...
			base += (c.getActionSender().getLevelForXP(c.playerXP[3]) - c.playerLevel[3]) / 2;
	...
	/**
	 * If the player has a salve amulet and he's wearing it.
	 * 
	 * @param c
	 * @return
	 */
	public static final boolean hasSalveAmulet(Player c) {
		return c.playerEquipment[c.playerWeapon] == 10588;
	}
